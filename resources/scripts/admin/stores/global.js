...
export const useGlobalStore = (useWindow = false) => {
  ...
  return defineStoreFunc({
   ...
   /*  getters: {
      menus: (state) => {
        return Object.values(state.mainMenu)
      },
    },  */
    ...
    actions: {
        ...
        return new Promise((resolve, reject) => {
          axios
            ...
            .then((response) => {
              ...
              this.topMenu = response.data.top_menu
              this.settingMenu = response.data.setting_menu

              this.config = response.data.config
             // console.log('Global config:', this.config.languages)
      ...
      fetchConfig(params) {
        console.log('Fetching config with params:', params);
        return new Promise((resolve, reject) => {
          axios
