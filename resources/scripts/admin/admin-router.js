...
const EmployeeCreate = () => import('@/scripts/admin/views/employee/Create.vue')
...
// Menu
const MenuIndex = () => import('@/scripts/admin/views/menu/Index.vue')
...
export default [
  ...
  },
  {
    ...
    children: [
      ...
      {
        path: 'hr_management/personal_information',
        name: 'hr_management',
