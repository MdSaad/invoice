      ...
      <div class="flex items-center gap-4 font-normal text-gray-700">
        ...
        >
          ...
          <router-link
            v-if="item.path"
            :to="item.path"
            class="flex text-white items-center gap-2"
            :class="{
          ...
          <ChevronDownIcon
            ...
            :class="[
              'ml-auto text-white w-5 h-5 transition-transform duration-200',
...
import TopMenuTree from './TopMenuTree.vue'; // self-reference for recursion
